...
cl /I..\include ..\src\game.cpp -LD /link -incremental:no -opt:ref -PDB:stream_%random%.pdb ..\lib\SDL2.lib ..\lib\SDL2main.lib ..\lib\SDL2_image.lib -EXPORT:GAME_INIT -EXPORT:GAME_HANDLE_INPUT -EXPORT:GAME_UPDATE_AND_RENDER -EXPORT:GAME_SOUND_AND_DEBUG
